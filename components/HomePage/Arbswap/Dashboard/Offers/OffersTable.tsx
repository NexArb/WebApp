...
function DashboardTable({ seller, payment, amount, price }: OfferProps) {
  return (
    <tr className="flex items-center justify-center border-b border-solid border-zinc-400">
      ...
      <td>
        <Button className="ml-10 mr-6 border border-emerald-400 bg-emerald-400 bg-opacity-10 px-8 py-2">
          <span className="text-emerald-400 ">ACCEPT</span>
        </Button>
      </td>
      <td>
        <Button className="mr-6 border border-red-600 bg-red-600 bg-opacity-10 px-8 py-2">
          <span className="text-red-600">REJECT</span>
        </Button>
      </td>
      <td>
        <Button className="mr-5 border border-blue-600 bg-blue-600 bg-opacity-10 px-8 py-2">
