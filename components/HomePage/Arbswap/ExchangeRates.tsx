  ...
  return (
    <div className="bg-indigo-950 w-80 rounded-2xl p-5">
      ...
      <div className="flex  justify-between mt-6">
        <div className={`${color} rounded-full my-auto py-1.5 px-5`}>
          {lowestPrice > price ? "-" : "+"} {(Math.abs(Number(lowestPrice) - Number(price)) / 100).toFixed(2)}%
        </div>
        <div className='w-20 h-14 my-auto'>
