  ...
  <div className="mx-auto max-w-sm overflow-hidden rounded-3xl bg-pricing-box from-purple-700 to-purple-900 p-5 text-white shadow-lg">
    <div className="p-5">
      ...
      <div className="mb-10 mt-20 flex justify-center">
        <span className="mb-2 mr-2 inline-flex items-center rounded-full px-3 py-1 text-3xl font-semibold text-white">
          € 19,50
        </span>
      </div>
      <div className="my-10 flex justify-center">
        <button className="text-s inline-block rounded-3xl bg-pricing-button px-10 py-3 font-semibold uppercase leading-tight text-white shadow-md">
          Purchase
        </button>
      </div>
    </div>
