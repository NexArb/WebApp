...
export const aboutPageDictionary: Record<string, About> = {
    en: {
        ...
        description: "Advantages include excellent sound quality, and the fact that they do not require any batteries. Gamers often prefer wired headphones so they never have to worry about batteries dying in the middle of a heated match.",
        manyUsefulComponents: "Many Useful Components",
        manyUsefulComponentsDesc: "Startup Framework contains components and complex blocks which can be easily be integrated into almost any design.",
        responsiveLayout: "Responsive Layout",
        responsiveLayoutDesc: "We haven`t forgotten about responsive layout. With Startup Framework, you can create a website with full mobile support.",
        retinaReady: "Retina Ready",
        retinaReadyDesc: "Startup Framework works on devices supporting Retina Display. Feel the clarity in each pixel."
    },
    tr: {
        aboutNexarb: "NexArb Hakkında",
        description: "Avantajlar kusursuz ses kalitesi ile hiçbir bataryaya gereksinim olmamasını içerir. Oyuncular sıklıkla kablolu kulaklıkları tercih eder bu yüzden çekişmeli bir oyunun ortasında bataryanın tükenmesinden endişe etmelerine gerek yok.",
        manyUsefulComponents: "Birçok Kullanışlı Bileşenler",
        manyUsefulComponentsDesc: "Startup Framework herhangi bir tasarıma kolaylıkla entegre olabilen bileşenler ve kompleks bloklar içerir.",
        responsiveLayout: "Duyarlı Sayfa Düzeni",
        responsiveLayoutDesc: "Duyarlı sayfa düzenini de unutmadık. Startup Framework ile tam mobil destekli bir website geliştirebilirsiniz.",
        retinaReady: "Retina Hazır",
        retinaReadyDesc: "Startup Framework Retina ekranını destekleyen cihazlarda çalışır. Her bir pikselde netliği hissedin."
    },
    de: {
        aboutNexarb: "Über NexArb",
        description: "Zu den Vorteilen zählen die hervorragende Klangqualität und die Tatsache, dass keine Batterien erforderlich sind. Gamer bevorzugen häufig kabelgebundene Kopfhörer, sodass sie sich nie Sorgen machen müssen, dass die Batterien mitten in einem hitzigen Spiel leer werden.",
        manyUsefulComponents: "Viele nützliche Komponenten",
        manyUsefulComponentsDesc: "Das Startup Framework enthält Komponenten und komplexe Blöcke, die problemlos in nahezu jedes Design integriert werden können.",
        responsiveLayout: "Responsive Layout",
        responsiveLayoutDesc: "Wir haben das responsive Layout nicht vergessen. Mit Startup Framework können Sie eine Website mit vollständiger Mobilunterstützung erstellen.",
        retinaReady: "Retina Bereit",
        retinaReadyDesc: "Das Startup Framework funktioniert auf Geräten, die Retina Display unterstützen. Spüren Sie die Klarheit in jedem Pixel."
    }
}
...
export const arbSwapHomeDictionary: Record<string, ArbSwapHome> = {
    en: {
        ...
        introDescription: "Join our peer-to-peer trading platform and use the fastest and most secure payment method for buying and selling Solana with users just like you.",
        ...
        solanaWorldDescription: "Join NexArb to get the latest news and start trading now.",
        signUpNow: "Sign Up Now",
        confidentiality: "Confidentiality",
        confidentialityDesc: "We do not store personal data on our servers and never transfer it to third parties."
    },
    tr: {
        introHeader: "En hızlı & güvenli transfer Solana",
        introDescription: "Peer-to-peer ticaret platformumuza katılın ve sizin gibi Solana alan ve satan kullanıcılarla en hızlı ve en güvenli ödeme yöntemini kullanın.",
        getStarted: "Başlayın",
        buySOL: "SOL Al",
        sellSOL: "SOL Sat",
        amount: "Miktar",
        ...
        solanaWorldDescription: "En yeni haberleri almak ve şimdi ticarete başlamak için NexArb'a katılın.",
        signUpNow: "Şimdi Kayıt Ol",
        confidentiality: "Gizlilik",
        confidentialityDesc: "Sunucularımızda kişisel verileri tutmayız ve onları üçüncü partilere aktarmayız."
    },
    de: {
        introHeader: "Schnellster und sicherer Transfer Solana",
        introDescription: "Treten Sie unserer Peer-to-Peer-Handelsplattform bei und nutzen Sie die schnellste und sicherste Zahlungsmethode für den Kauf und Verkauf von Solana mit Benutzern wie Ihnen.",
        getStarted: "Loslegen",
        ...
        sendAndRecieveDesc: "Senden und empfangen Sie Solana ganz einfach von überall aus",
        ...
        startTradingDesc: "Beginnen Sie mit dem Handel zu Ihrem gewünschten Kurs und lassen Sie sich auszahlen.",
        solanaWorld: "Machen Sie sich bereit, die Solana-Welt zu erkunden.",
        solanaWorldDescription: "Melden Sie sich bei NexArb an, um die neuesten Nachrichten zu erhalten und jetzt mit dem Handel zu beginnen.",
        signUpNow: "Jetzt Registrieren",
        confidentiality: "Vertraulichkeit",
        confidentialityDesc: "Wir speichern keine personenbezogenen Daten auf unseren Servern und geben diese niemals an Dritte weiter."
    }
}

export const nexBridgeHomeDictionary: Record<string, NexBridgeHome> = {
    en: {
        description: "Join our peer-to-peer trading platform and use the fastest and most secure payment method for buying and selling Solana with users just like you.",
        crossChain: "Cross-chain Bridge"
    },
    tr: {
        description: "Peer-to-peer ticaret platformumuza katılın ve sizin gibi Solana alan ve satan kullanıcılarla en hızlı ve en güvenli ödeme yöntemini kullanın.",
        crossChain: "Cross-chain Köprü"
    },
    de: {
        description: "Treten Sie unserer Peer-to-Peer-Handelsplattform bei und nutzen Sie die schnellste und sicherste Zahlungsmethode für den Kauf und Verkauf von Solana mit Benutzern wie Ihnen.",
...
export const homeDictionary: Record<string, Home> = {
    en: {
        ...
        digitalSolutionsDesc: "Startup Framework gives you complete freedom over your creative process — you don’t have to think about any technical aspects. There are no limits and absolutely no coding.",
        letsMeet: "Let's Meet",
        ourWorks: "Our Works",
        ourWorksDesc: "The most important part of the Startup Framework is the samples. The samples form a set of 20 usable pages you can use as is or you can add new blocks from UI Kit.",
        startupCrew: "Startup Crew",
    },
    tr: {
        digitalSolutions: "Gelecek İçin Dijital Çözümler",
        digitalSolutionsDesc: "Startup Framework size yaratıcı sürecinizde tam özgürlük verir - herhangi bir teknik durum hakkında düşünmek zorunda değilsiniz. Hiçbir sınır ve kodlama yoktur.",
        letsMeet: "Haydi Buluşalım",
        ourWorks: "Çalışmalarımız",
        ourWorksDesc: "Startup Framework'ün en önemli yönü örneklerdir. Örnekler olduğu gibi kullanabileceğiniz 20 kullanılabilir sayfaya şekil verir veya UI Kit'ten yeni bloklar ekleyebilirsiniz.",
        startupCrew: "Startup Ekibi",
    },
    de: {
        digitalSolutions: "Digitale Lösungen für die Zukunft“",
        digitalSolutionsDesc: "Das Startup Framework gibt Ihnen völlige Freiheit bei Ihrem kreativen Prozess – Sie müssen sich keine Gedanken über technische Aspekte machen. Es gibt keine Grenzen und absolut keine Codierung.",
        letsMeet: "Lass uns treffen",
        ourWorks: "Unsere Arbeiten",
        ourWorksDesc: "Der wichtigste Teil des Startup Frameworks sind die Beispiele. Die Beispiele bilden einen Satz von 20 verwendbaren Seiten, die Sie unverändert verwenden oder neue Blöcke aus dem UI-Kit hinzufügen können.",
        startupCrew: "Startup-Crew",
    }
}
...
export const nexBridgeDashboardDictionary: Record<string, NexBridgeDashboard> = {
    en: {
        ...
        from: "From :",
        to: "To :",
        personalData: "We do not store personal data on our servers and never transfer it to third parties.",
    ...
    tr: {
        ...
        from: "Kimden :",
        to: "Kime :",
        personalData: "Kişisel verileri sunucularımızda tutmayız ve asla üçüncü partilere aktarmayız.",
    ...
    de: {
        ...
        from: "Aus :",
        to: "Zu :",
        personalData: "Wir speichern keine personenbezogenen Daten auf unseren Servern und geben diese niemals an Dritte weiter.",
...
export const registerDictionary: Record<string, Register> = {
    ...
    de: {
        ...
        acceptTermsConditions: "Akzeptieren Sie die Allgemeinen Geschäftsbedingungen...",
        next: "Nächste"
    }
}
...
export const registerWalletDictionary: Record<string, RegisterWallet> = {
    ...
    tr: {
        connectPhantomWallet: "Kayıt olmaya devam etmek için Phantom wallet'ınızı bağlayın",
        connectWallet: "Wallet Bağla",
        register: "Kayıt Ol"
    },
    de: {
        connectPhantomWallet: "Verbinden Sie Ihr Phantom-Wallet, um mit der Registrierung fortzufahren.",
        connectWallet: "Wallet verbinden",
...
export const arbSwapFooterDictionary: Record<string, ArbSwapFooter> = {
    en: {
        dummyText: "Filler text is dummy text which has no meaning however looks very similar to real text",
        products: "PRODUCTS",
        overview: "Overview",
        solutions: "Solutions",
        pricing: "Pricing",
    ...
    tr: {
        dummyText: "Doldurucu metin anlamı olmayan ancak gerçek metne çok benzeyen anlamsız metindir",
        products: "ÜRÜNLER",
    ...
    de: {
        dummyText: "Fülltext ist Blindtext, der keine Bedeutung hat, aber echtem Text sehr ähnlich sieht",
        products: "PRODUKTE",
        overview: "Überblick",
        solutions: "Lösungen",
        pricing: "Preisgestaltung",
...
export const footerDictionary: Record<string, Footer> = {
    ...
    tr: {
        ...
        description: "Tasarımcılara, geliştiricilere ve şirketlere startupları için hızlı ve kolayca website geliştirmelerinde yardım edecek yeni bir ürün oluşturduk.",
        yourName: "İsminiz",
    ...
    de: {
        ...
        description: "Wir haben ein neues Produkt entwickelt, das Designern, Entwicklern und Unternehmen dabei hilft, schnell und einfach Websites für ihre Startups zu erstellen.",
        yourName: "Dein Name",
