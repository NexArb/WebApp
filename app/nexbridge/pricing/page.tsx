...
function NexBridgePricing (): React.JSX.Element {
  return (
...
function PriceBox (): React.JSX.Element {
  return (
    <div className="max-w-sm mx-auto bg-pricing-box p-5 from-purple-700 to-purple-900 text-white rounded-3xl shadow-lg overflow-hidden">
      <div className="p-5">
        ...
        <div className="flex justify-center mt-20 mb-10">
          <span className="inline-flex items-center rounded-full px-3 py-1 text-3xl font-semibold text-white mr-2 mb-2">
            € 19,50
          </span>
        </div>
