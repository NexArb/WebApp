...
function page() {
    ...
    return (
        <section className="justify-center pt-12 md:flex">
            ...
            {/* Right Rectangle */}
            <div
                className="sm:w-5/5 max-h-[739px] max-w-4xl  rounded-3xl border bg-zinc-100 px-3 py-4 backdrop-blur-[100px] sm:!m-3 md:w-4/5 md:px-7">
                <div className={' custom-scrollbar !scroll-p-6 overflow-y-scroll'}>
                    <div className=" text-black">
                        <div
                            className=" mx-5 my-2 whitespace-nowrap border-0 md:border-b border-black text-lg font-medium text-neutral-400">
                    ...
                    <div
                        className="custom-scrollbar h-[655px] w-[830px] scroll-p-96  flex-col  !whitespace-nowrap bg-zinc-100 py-0 ">
